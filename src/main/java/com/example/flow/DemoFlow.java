...
public class DemoFlow {
    ...
    public static void main(String[] args) {
        ...
        try (SubmissionPublisher<Integer> publisher = new SubmissionPublisher<>()) {
            ...
            for (int i = 1; i <= 5; i++) {
                publisher.submit(i);
                System.out.println(Thread.currentThread().getName() + " submitted: " + i);
            }
...
class DoubleProcessor extends SubmissionPublisher<Integer> implements Processor<Integer, Integer> {
